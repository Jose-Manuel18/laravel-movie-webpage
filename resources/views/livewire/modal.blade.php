<div class="fixed inset-0 z-50 flex items-center justify-center overflow-y-auto"
    ...
    <div
        class="relative bg-white rounded-lg text-left overflow-hidden shadow-xl transform transition-all sm:max-w-lg sm:w-full m-auto">
        <div class="bg-white p-2 flex flex-col h-full">
            <div class="sm:flex sm:items-start flex-grow">
                <div class="text-center sm:text-left flex-grow">
                    <div class="mt-2 flex-grow relative">
                        ...
                        @else
                            <p class="text-sm text-center leading-5 text-gray-500">No trailer available.</p>
                        @endif
                    </div>
                </div>
            </div>
